...
<div class="flex h-full">
    ...
    <aside class="fixed left-0 top-0 bottom-0 z-40 w-72 lg:w-64 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 flex flex-col
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
            ...
            <p class="pt-4 pb-1 px-3 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Management</p>
            ...
            <p class="pt-4 pb-1 px-3 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Operations</p>
            ...
            @if(auth()->user()->hasRole('admin'))
            <p class="pt-4 pb-1 px-3 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Finance</p>
            ...
            <p class="pt-4 pb-1 px-3 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">System</p>
...
<nav class="lg:hidden fixed bottom-0 left-0 right-0 z-20 bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 flex">
    <a href="{{ route('dashboard') }}" class="flex-1 flex flex-col items-center justify-center py-2.5 gap-1 text-xs font-medium {{ request()->routeIs('dashboard') ? 'text-violet-600 dark:text-violet-400' : 'text-slate-500 dark:text-slate-400' }}">
        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
        Home
    </a>
    <a href="{{ route('schedules.index') }}" class="flex-1 flex flex-col items-center justify-center py-2.5 gap-1 text-xs font-medium {{ request()->routeIs('schedules.*') ? 'text-violet-600 dark:text-violet-400' : 'text-slate-500 dark:text-slate-400' }}">
        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
        Jadwal
    </a>
    <a href="{{ route('reports.index') }}" class="flex-1 flex flex-col items-center justify-center py-2.5 gap-1 text-xs font-medium {{ request()->routeIs('reports.*') ? 'text-violet-600 dark:text-violet-400' : 'text-slate-500 dark:text-slate-400' }}">
        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
        Report
    </a>
    <a href="{{ route('findings.index') }}" class="flex-1 flex flex-col items-center justify-center py-2.5 gap-1 text-xs font-medium {{ request()->routeIs('findings.*') ? 'text-violet-600 dark:text-violet-400' : 'text-slate-500 dark:text-slate-400' }}">
