<div class="max-w-3xl mx-auto space-y-6">
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" wire:model="company_name" placeholder="PT. Example Indonesia" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-gray-900 dark:text-white placeholder-gray-400 focus:border-stone-500 focus:ring-2 focus:ring-stone-500/20 outline-none transition" />
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea wire:model="address" rows="2" placeholder="Full company address..." class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-gray-900 dark:text-white placeholder-gray-400 focus:border-stone-500 focus:ring-2 focus:ring-stone-500/20 outline-none transition resize-none"></textarea>
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" wire:model="pic_name" placeholder="John Doe" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-gray-900 dark:text-white placeholder-gray-400 focus:border-stone-500 focus:ring-2 focus:ring-stone-500/20 outline-none transition" />
                ...
                <div>
                    ...
                    <input type="email" wire:model="pic_email" placeholder="john@example.com" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-gray-900 dark:text-white placeholder-gray-400 focus:border-stone-500 focus:ring-2 focus:ring-stone-500/20 outline-none transition" />
                ...
                <div>
                    ...
                    <input type="text" wire:model="pic_phone" placeholder="+62 812 3456 7890" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-gray-900 dark:text-white placeholder-gray-400 focus:border-stone-500 focus:ring-2 focus:ring-stone-500/20 outline-none transition" />
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-600 p-4">
                    ...
                    <button type="button" wire:click="$toggle('is_active')" class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors {{ $is_active ? 'bg-stone-600' : 'bg-gray-300 dark:bg-gray-600' }}">
                ...
                <div>
                    ...
                    <textarea wire:model="notes" rows="3" placeholder="Any internal notes about this client..." class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-gray-900 dark:text-white placeholder-gray-400 focus:border-stone-500 focus:ring-2 focus:ring-stone-500/20 outline-none transition resize-none"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-3">
            ...
            <button type="submit" wire:loading.attr="disabled" class="rounded-lg bg-stone-600 px-6 py-2.5 text-sm font-medium text-white hover:bg-stone-700 disabled:opacity-60 transition-colors">
